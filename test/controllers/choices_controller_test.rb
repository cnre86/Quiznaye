...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { correct: @choice.correct, question_id: @choice.question_id, text: @choice.text } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { correct: @choice.correct, question_id: @choice.question_id, text: @choice.text } }
